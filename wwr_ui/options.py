...
OPTIONS = {
  ...
  "progression_great_fairies":
    "This controls whether the items given by Great Fairies can be progress items.<br>"
  ...
  "progression_puzzle_secret_caves":
    "This controls whether puzzle-focused secret caves can contain progress items.<br>"
    "<u>If this is not checked, they will still be randomized</u>, but will only contain optional items you don't need to beat the game.",
  "progression_combat_secret_caves":
    "This controls whether combat-focused secret caves (besides Savage Labyrinth) can contain progress items.<br>"
    "<u>If this is not checked, they will still be randomized</u>, but will only contain optional items you don't need to beat the game.",
  "progression_short_sidequests":
    "This controls whether sidequests that can be completed quickly can reward progress items.<br>"
  ...
  "progression_long_sidequests":
    "This controls whether long sidequests (e.g. Lenzo's assistant, withered trees, goron trading) can reward progress items.<br>"
    "<u>If this is not checked, they will still be randomized</u>, but will only reward optional items you don't need to beat the game.",
  "progression_spoils_trading":
    "This controls whether the items you get by trading in spoils to NPCs can be progress items.<br>"
    "<u>If this is not checked, they will still be randomized</u>, but will only reward optional items you don't need to beat the game.",
  "progression_minigames":
    "This controls whether most minigames can reward progress items (auctions, mail sorting, barrel shooting, bird-man contest).<br>"
  ...
  "progression_free_gifts":
    "This controls whether gifts freely given by NPCs can be progress items (Tott, Salvage Corp, imprisoned Tingle).<br>"
    "<u>If this is not checked, they will still be randomized</u>, but will only be optional items you don't need to beat the game.",
  "progression_mail":
    "This controls whether mail can contain progress items.<br>"
  ...
  "progression_platforms_rafts":
    "This controls whether lookout platforms and rafts can contain progress items.<br>"
    "<u>If this is not checked, they will still be randomized</u>, but will only contain optional items you don't need to beat the game.",
  "progression_submarines":
    "This controls whether submarines can contain progress items.<br>"
  ...
  "progression_eye_reef_chests":
    "This controls whether the chests that appear after clearing out the eye reefs can contain progress items.<br>"
    "<u>If this is not checked, they will still be randomized</u>, but will only contain optional items you don't need to beat the game.",
  "progression_big_octos_gunboats":
    "This controls whether the items dropped by Big Octos and Gunboats can contain progress items.<br>"
    "<u>If this is not checked, they will still be randomized</u>, but will only contain optional items you don't need to beat the game.",
  "progression_triforce_charts":
    "This controls whether the sunken treasure chests marked on Triforce Charts can contain progress items.<br>"
    "<u>If this is not checked, they will still be randomized</u>, but will only contain optional items you don't need to beat the game.",
  "progression_treasure_charts":
    "This controls whether the sunken treasure chests marked on Treasure Charts can contain progress items.<br>"
    "<u>If this is not checked, they will still be randomized</u>, but will only contain optional items you don't need to beat the game.",
  "progression_expensive_purchases":
    "This controls whether items that cost a lot of rupees can be progress items (Rock Spire shop, auctions, Tingle's letter, trading quest).<br>"
    "<u>If this is not checked, they will still be randomized</u>, but will only be optional items you don't need to beat the game.",
  "progression_misc":
    "Miscellaneous locations that don't fit into any of the above categories (outdoors chests, wind shrine, Cyclos, etc).<br>"
    "<u>If this is not checked, they will still be randomized</u>, but will only contain optional items you don't need to beat the game.",
  "progression_tingle_chests":
    "Tingle Chests that are hidden in dungeons and must be bombed to make them appear. (2 in DRC, 1 each in FW, TotG, ET, and WT).<br>"
    "<u>If this is not checked, they will still be randomized</u>, but will only contain optional items you don't need to beat the game.",
  "progression_battlesquid":
    "This controls whether the Windfall battleship minigame can reward progress items.<br>"
  ...
  "progression_savage_labyrinth":
    "This controls whether the Savage Labyrinth can contain progress items.<br>"
  ...
  "randomize_great_fairy_entrances":
    "Shuffles the entrances to all great fairy fountains.",
  "randomize_charts":
  ...
  "custom_player_model":
    "Replaces Link's model with a custom player model.<br>"
